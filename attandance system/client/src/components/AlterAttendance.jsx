  ...
  const navigate=useNavigate()
    ...
    async function sending(){
        ...
        if(getting.dept&&getting.batch){
            await axios.post(server+'/newattendance',{Student,present,role:"admin"}).then(res=>{
                if(res.data=="Students Attendance was modified Successfully"){
    ...
    return(
       ...
       <div className="container">
        ...
        <div className="row mt-4">
           <div className="col"><center><h1>Alter Attendance System</h1></center></div>
        </div>
